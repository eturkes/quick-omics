...
Note that for now we don't use the adjusted p-value for thresholding as they are all greater than $0.05$.
This may be do to an error in the analysis so that will be double-checked.

```{r, DEG}
data <- read.delim(file.path(assets_dir, "GEO2R.txt"))
data <- data[which(data$P.Value < 0.05), ] #TODO: Double-check multiple testing correction.
```
