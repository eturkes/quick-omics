---
title: '01 Analysis - `r unlist(strsplit(getwd(), "/"))[6]`'
author:
  - name: "Emir Turkes [emir.turkes@eturkes.com]"
  - name: "UK Dementia Research Institute at UCL"
date: '`r strftime(Sys.time(), format = "%B %d, %Y")`'
bibliography: '../../`r unlist(strsplit(getwd(), "/"))[6]`.bib'
link-citations: true
output:
  html_document:
    code_folding: hide
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(
    "..", "..", "results", unlist(strsplit(getwd(), "/"))[8], "01-analysis.html"
  ))})
---
...
The data here is derived from @`r unlist(strsplit(getwd(), "/"))[8]` and will be referenced using the name ``r unlist(strsplit(getwd(), "/"))[8]``.
